...
<div class="is-flex is-align-items-center">
    <a class="button button-blue" href="/user">
        <Icon icon={faArrowLeft} />
    </a>
    <h1 class="subtitle ml-2 has-text-white">Add User</h1>
</div>
...
<form class="mx-auto is-full" on:submit={handleSubmit}>
    <fieldset>
        ...
        <div class="field">
            <div class="control">
                <button class="button button-blue is-pulled-right" disabled={!isPasswordMatch || !isPasswordValid || user.assignedSchoolId === 0 || user.userTypeId === 0}>Add</button>
            </div>
        </div>
    </fieldset>
</form>
