...
<form class="mx-auto" on:submit={handleSubmit}>
    <fieldset>
        <section class="section">
            <div class="container">
                <div class="card mx-auto" style="max-width: 600px; background-color: white;">
                    <div class="card-content">
                        <div class="profile-picture-container mb-4">
                            {#if previewImage}
                                <img src={previewImage} alt="School Picture" class="profile-picture">
                            {:else if school.imagePath != null}
                                <img src='\{school.imagePath}' alt="School Picture" class="profile-picture">
                            {:else}
