...
<script lang="ts">
	...
	import { addShift, getTimePolicyCode } from "../repo";
    ...
    async function handleSubmit(e:Event){
        ...
        try {
            const callResult:CallResultDto<object> = await addShift(shift);
    ...
    onMount(async () => {
        try{
            ...
            if(timePolicyCodesResponse.isSuccess){
                ...
                errorMessage = timePolicyCodesResponse.message;
            }
        }catch(err: any){
...
<div class="is-flex is-align-items-center mb-3">
    ...
    <h1 class="subtitle ml-2">Add Shift</h1>
</div>
